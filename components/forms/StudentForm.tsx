  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <Field
        ...
        htmlFor="responsibleContactName"
        error={fieldError(state, "responsibleContactName")}
        hint="Obligatorio si el alumno es menor de edad."
      >
        <Input
          id="responsibleContactName"
          name="responsibleContactName"
          value={values.responsibleContactName}
          onChange={(e) => setField("responsibleContactName", e.target.value)}
        />
      </Field>

      <Field
        label="Teléfono del responsable"
        htmlFor="responsibleContactPhone"
        error={fieldError(state, "responsibleContactPhone")}
      >
        <Input
          id="responsibleContactPhone"
          name="responsibleContactPhone"
          value={values.responsibleContactPhone}
          onChange={(e) => setField("responsibleContactPhone", e.target.value)}
        />
      </Field>
